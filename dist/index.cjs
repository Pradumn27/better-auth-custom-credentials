...
// src/server.ts
var defaultSchema = zod.z.object({
...
function credentialsPlugin(opts) {
  ...
  return {
    id: "credentials",
    endpoints: {
      signIn: api.createAuthEndpoint(path, { method: "POST" }, async (ctx) => {
...
exports.credentialsPlugin = credentialsPlugin;
exports.extendAuthClientWithCredentials = extendAuthClientWithCredentials;
